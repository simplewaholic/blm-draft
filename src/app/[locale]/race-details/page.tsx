...
import { Calendar, MapPin, Trophy, Users, Clock, Mountain, Route, AlertTriangle, ChevronDown, Package, Shirt } from 'lucide-react';
...
const RaceDetails = () => {
  ...
  const schedule = [
    { 
      ...
      description: "Nhận số báo danh, kiểm tra trang thiết bị bắt buộc, briefing an toàn"
    },
    { 
      date: "14/12/2024",
      time: "19:00 - 21:00", 
    ...
    { 
      ...
      description: "Trao giải cho các hạng mục Nam/Nữ/Đồng đội 100K - Kết thúc sự kiện"
    }
  ];
  
  const shirtSizes = [
    { size: "XS", chest: "84-89cm", description: "Phù hợp cho người có vòng ngực 84-89cm" },
    { size: "S", chest: "89-94cm", description: "Phù hợp cho người có vòng ngực 89-94cm" },
    { size: "M", chest: "94-99cm", description: "Phù hợp cho người có vòng ngực 94-99cm" },
    { size: "L", chest: "99-104cm", description: "Phù hợp cho người có vòng ngực 99-104cm" },
    { size: "XL", chest: "104-109cm", description: "Phù hợp cho người có vòng ngực 104-109cm" },
    { size: "XXL", chest: "109-114cm", description: "Phù hợp cho người có vòng ngực 109-114cm" }
  ];
  ...
  const courseInfo = {
    "25K": {
      description: "Tuyến đường 25K phù hợp cho người mới bắt đầu với trail running, đi qua những con đường mòn đẹp nhất của Măng Đen.",
      highlights: [
    ...
    "50K": {
      description: "Cự ly thử thách với địa hình phức tạp, yêu cầu kinh nghiệm trail running và sự chuẩn bị kỹ lưỡng.",
      highlights: [
    ...
    "100K": {
      description: "Ultra marathon đầy thử thách, dành cho những vận động viên có kinh nghiệm và sự chuẩn bị tốt nhất.",
      highlights: [
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch(difficulty) {
      ...
      case "Khó": return "text-orange-600 bg-orange-50";
      case "Rất khó": return "text-red-600 bg-red-50";
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 space-y-16">
              ...
              <CardContent className="p-8">
                <div className="prose max-w-none">
                  <p className="text-gray-600 mb-4 text-lg">
                    Măng Đen Ultra Trail là giải chạy trail thường niên được tổ chức tại cao nguyên Măng Đen, 
                    Kon Tum. Đây là một trong những giải chạy trail thử thách nhất Việt Nam với địa hình đa dạng 
                    từ rừng thông, thác nước đến những con đường mòn núi hiểm trở.
                  </p>
                  <p className="text-gray-600 mb-8 text-lg">
                    Giải chạy không chỉ là thử thách thể chất mà còn là cơ hội để vận động viên khám phá vẻ đẹp 
                    hoang sơ của thiên nhiên Tây Nguyên, trải nghiệm văn hóa địa phương độc đáo.
                  </p>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="text-center p-6 bg-gray-50 rounded-lg">
                      <Mountain className="w-8 h-8 mx-auto mb-4" />
                      <h3 className="font-bold">Địa hình đa dạng</h3>
                      <p className="text-sm text-gray-600">Rừng thông, thác nước, đường mòn núi</p>
                    </div>
                    <div className="text-center p-6 bg-gray-50 rounded-lg">
                      <Users className="w-8 h-8 mx-auto mb-4" />
                      <h3 className="font-bold">Cộng đồng đam mê</h3>
                      <p className="text-sm text-gray-600">Kết nối các trail runner Việt Nam</p>
                    </div>
                    <div className="text-center p-6 bg-gray-50 rounded-lg">
                      <Trophy className="w-8 h-8 mx-auto mb-4" />
                      <h3 className="font-bold">Thử thách bản thân</h3>
                      <p className="text-sm text-gray-600">Vượt qua giới hạn của chính mình</p>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          {/* Distances Section */}
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-center">Các cự ly thi đấu</h2>
            
            <div className="flex flex-wrap justify-center gap-2 mb-8">
              {distances.map((distance, index) => (
                <Button
                  key={index}
                  variant={selectedDistance === distance.name.split(' ')[0] ? "default" : "outline"}
                  onClick={() => setSelectedDistance(distance.name.split(' ')[0])}
                  className="mb-2"
                >
                  {distance.name}
                </Button>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h4 className="font-bold mb-4 text-lg">🗺️ Điểm nổi bật</h4>
                      <ul className="space-y-2">
                        {courseInfo[selectedDistance].highlights.map((highlight, idx) => (
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-gray-600">{courseInfo[selectedDistance].terrain}</p>
                      </div>
                      
                      <div>
                        <h4 className="font-bold mb-2">⚠️ Độ khó</h4>
                        <span className={`px-3 py-1 rounded-full text-sm font-medium ${getDifficultyColor(courseInfo[selectedDistance].difficulty)}`}>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{courseInfo[selectedDistance].checkpoints} điểm</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-6">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-bold text-blue-800 mb-2">Lưu ý quan trọng</h4>
                        <p className="text-blue-700 text-sm">
                          Vận động viên cần chuẩn bị kỹ lưỡng về thể lực và trang thiết bị. 
                          Đọc kỹ quy định về trang bị bắt buộc trước khi tham gia.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-center">Thông tin đăng ký</h2>
            <Card>
              <CardContent className="p-8">
                <div className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h3 className="font-bold mb-4 text-xl">Thời gian đăng ký</h3>
                    ...
                    <div>
                      <h3 className="font-bold mb-4 text-xl">Yêu cầu tham gia</h3>
                      <ul className="space-y-2 text-gray-600">
                        <li>• Tuổi từ 18-65</li>
          ...
          {/* Shirt Sizes Section */}
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-center">Size áo thi đấu</h2>
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  <Shirt className="mr-3" size={24} />
                  <h3 className="text-2xl font-bold">Bảng size áo chính thức</h3>
                </div>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {shirtSizes.map((shirt, index) => (
                    <div key={index} className="border rounded-lg p-4 text-center">
                      <h4 className="text-xl font-bold mb-2">{shirt.size}</h4>
                      <p className="text-lg text-green-600 font-semibold mb-1">{shirt.chest}</p>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-6">
                  <p className="text-yellow-800 text-sm">
                    <strong>Lưu ý:</strong> Vui lòng chọn size chính xác khi đăng ký. 
                    Không thể đổi size sau khi đăng ký thành công.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          {/* Required Equipment Section - Now Dynamic */}
            <div className="space-y-8">
            <h2 className="text-3xl font-bold text-center">Trang thiết bị bắt buộc</h2>
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold">Trang thiết bị cho cự ly {selectedDistance}</h3>
                </div>
                
                <div className="grid md:grid-cols-3 gap-8">
                  {/* Mandatory Equipment */}
                  <div>
                    <h4 className="font-bold text-lg mb-4 text-red-600">🔴 Bắt buộc</h4>
                    <ul className="space-y-2">
                      {requiredEquipmentByDistance[selectedDistance].mandatory.map((item, index) => (
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-4 text-yellow-600">🟡 Khuyến nghị</h4>
                    <ul className="space-y-2">
                      {requiredEquipmentByDistance[selectedDistance].recommended.map((item, index) => (
                        <li key={index} className="flex items-start space-x-2">
                  ...
                  {/* Prohibited Items */}
                  <div>
                    <h4 className="font-bold text-lg mb-4 text-red-600">❌ Cấm sử dụng</h4>
                    <ul className="space-y-2">
                      {requiredEquipmentByDistance[selectedDistance].prohibited.map((item, index) => (
                        <li key={index} className="flex items-start space-x-2">
                          <span className="text-red-600 mt-1">•</span>
                          <span className="text-gray-700">{item}</span>
                        </li>
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-6 mt-8">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-bold text-red-800 mb-2">Kiểm tra trang thiết bị</h4>
                      <p className="text-red-700 text-sm">
                        BTC sẽ kiểm tra trang thiết bị bắt buộc trước khi xuất phát. 
                        Vận động viên thiếu bất kỳ trang thiết bị nào sẽ không được phép tham gia.
                        Yêu cầu trang thiết bị sẽ khác nhau tùy theo cự ly thi đấu.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-center">Lịch trình chi tiết</h2>
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  <Clock className="mr-3" size={24} />
                  <h3 className="text-2xl font-bold">Chương trình 2 ngày thi đấu</h3>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
                  ...
                  <ul className="text-blue-700 text-sm space-y-1">
                    <li>• Lịch trình có thể thay đổi tùy thuộc vào điều kiện thời tiết</li>
                    <li>• Vận động viên 100K sẽ chạy qua đêm từ 15/12 đến 16/12</li>
                    <li>• Tất cả thông tin cập nhật sẽ được thông báo qua email và website</li>
