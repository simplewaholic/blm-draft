...
const Hero = () => {
  ...
  return (
    ...
    <section
      id="home"
      className={`relative h-screen ${isMobile ? "mb-16" : ""}`}
    >
      {/* Background Slides */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`relative ${isMobile ? "z-10" : ""}`}>
              <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 transform rotate-1 hover:rotate-0 transition-transform duration-300">
                {/* Add slider image */}
                <div className="aspect-video relative rounded-2xl overflow-hidden">
                  {slidesCard.map((slide, index) => (
                    <div
                      className={`rounded-2xl absolute inset-0 transition-opacity duration-1000 ${
                        index === currentSlide ? "opacity-100" : "opacity-0"
                      }`}
                    >
                      <Image
                  ...
                  <div className="flex items-end justify-between absolute w-full bottom-0 left-0 p-2">
